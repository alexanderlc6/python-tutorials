...
from def_search import content_jieba, filter_words, append_word, extract_user_and_word
...
if __name__ == '__main__':
    ...
    # file_rdd = sc.textFile('hdfs://localhost:9000/user/alexlc/data/input/SogouQ.txt')
    split_rdd = file_rdd.map(lambda x:x.split('\t'))

    # Cache rdd data in disk
    ...
    # Requirement1 result: [('scala', 2310), ('hadoop', 2268), ('博学谷', 2002), ('传智汇', 1918), ('itheima', 1680)]
